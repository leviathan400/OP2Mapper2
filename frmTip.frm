...
Private Sub chkLoadTipsAtStartup_Click()
    ...
    SaveSettingIni "Options", "ShowTips", chkLoadTipsAtStartup.Value
End Sub
...
Private Sub Form_Load()
    ...
    ShowAtStartup = GetSettingIni("Options", "ShowTips", 1)
    ...
    If LoadTips(App.Path & "\" & TIP_FILE) = False Then
        lblTipText.Caption = "Error: the " & TIP_FILE & " file was not found."
    End If
