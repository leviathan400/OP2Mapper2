...
Attribute TabClose.VB_Description = "Raised when the close button is pressed for a tab."
...
Attribute TabBarClick.VB_Description = "Raised when the bar area (next to the tabs) is clicked."
Public Event TabSelected(theTab As cTab)
Attribute TabSelected.VB_Description = "Raised when a new tab has been selected."
...
Attribute Pinned.VB_Description = "Gets/sets whether the tab control is Pinned (fixed in place) or not (slides out on demand).  Only valid when the  Pinnable property is set to True."
   Pinned = m_bPinned
End Property
...
Attribute Pinnable.VB_Description = "Gets/sets whether the tab control is pinnable or not.  Use the Pinned property to set whether the tab control is pinned in place or slides out."
...
Attribute Shown.VB_Description = "Gets/sets whether the contents of the control are slid out when the control is in Pinnable mode and is not pinned."
   Shown = m_bOut
End Property
...
Attribute ClientLeft.VB_Description = "Gets the left position of the tab client area relative to the control, in pixels."
   ClientLeft = m_tClientR.Left
End Property
Public Property Get ClientTop() As Long
Attribute ClientTop.VB_Description = "Gets the top position of the tab client area relative to the control, in pixels."
   ClientTop = m_tClientR.Top
End Property
Public Property Get ClientWidth() As Long
Attribute ClientWidth.VB_Description = "Gets the width of the tab client area relative to the control, in pixels."
   ClientWidth = m_tClientR.Right - m_tClientR.Left
End Property
Public Property Get ClientHeight() As Long
Attribute ClientHeight.VB_Description = "Gets the height of the tab client area relative to the control, in pixels."
...
Attribute ImageList.VB_Description = "Associates an ImageList with the control.  Either set to a VB ImageList object, or the .hImageList (.hIml) property of any API ImageList."
    m_hIml = 0
    m_ptrVb6ImageList = 0
...
Attribute ForeColor.VB_Description = "Gets/sets the colour used to draw the tab captions."
...
Attribute SelectedFont.VB_Description = "Gets/sets the font used to display the selected tab caption."
Dim iFnt As iFont
Dim iFntC As iFont
...
Attribute Font.VB_Description = "Gets/sets the font used to display the tab captions."
Dim iFnt As iFont
Dim iFntC As iFont
   Set iFnt = m_font
   iFnt.Clone iFntC
...
Attribute ShowTabs.VB_Description = "Gets/sets whether the tabs should be displayed or not."
...
Attribute ShowCloseButton.VB_Description = "Gets/sets whether the close button should be shown or not."
...
Attribute AllowScroll.VB_Description = "Gets/sets whether the tabs can be scrolled or not.  If tabs are not scrollable, they are squashed to fit into the control, otherwise back and forward scroll arrows will be shown."
...
Attribute UnpinnedWidth.VB_Description = "Gets the width of the control when slid out in unpinned mode (Pinnable = True and Pinned = False)."
...
Private Sub drawTabs(Optional ByVal lhDCTo As Long = 0)
   ...
   If (m_bShowTabs) Then
      ...
      If (m_iTabCount > 0) Then
         ...
         'Debug.Print m_tButtonR.Left, m_tButtonR.Top, m_tButtonR.Right, m_tButtonR.Bottom
